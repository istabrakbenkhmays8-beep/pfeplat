ADVANCIA Trainings Platform — Claude Code Build Prompt
Paste this into Claude Code as your initial brief, or save it at the repo root as CLAUDE.md.
...
AI: provider-agnostic AIService adapter. Default to Groq (Llama 3.3 70B) or Anthropic Claude;
